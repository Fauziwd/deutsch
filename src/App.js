    ...
    <div className="relative flex justify-center text-left mt-2">
      ...
      <div id="dropdownDelay" className="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
        <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDelayButton">
          <li>
            <a href="nomen" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Kata Benda</a>
          </li>
          <li>
            <a href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Kata Sifat</a>
          </li>
          <li>
            <a href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Kata Kerja</a>
          </li>
        </ul>
      </div>
    </div>
      ...
      <div className="container mx-auto p-4 mt-8">
        ...
        <div className="flex justify-center space-x-4">
          <a href="#" className="bg-blue-500 hover:bg-blue-600 text-white px-5 py-2 rounded-lg">Kata Benda</a>
          <a href="#" className="bg-green-500 hover:bg-green-600 text-white px-5 py-2 rounded-lg">Kata Sifat</a>
          <a href="#" className="bg-yellow-500 hover:bg-yellow-600 text-white px-5 py-2 rounded-lg">Kata Kerja</a>
        </div>
      </div>

       <div className="container mx-auto p-4 mt-8">
       <div className="container mx-auto p-4 mt-8">
      <p className="text-xl font-semibold dark:text-white mb-4 text-center">Hausaufgabe!</p>
      <div className="flex justify-center space-x-4">
        <Link to="/kata-benda" className="bg-blue-500 hover:bg-blue-600 text-white px-5 py-2 rounded-lg">Ada Tugas?</Link>
      </div>
    </div>

      {/* Tampilan hasil dengan gambar */}
      <div className="mt-8 text-center">
        <p className="text-xl font-semibold dark:text-white mb-4">Hasil</p>
        <div className="w-48 h-48 mx-auto">
          <img src={hasilGambar} alt="Tugas" className="w-full h-full object-cover rounded-lg" />
        </div>
      </div>
    </div>
